            ...
            try
            {
                ...
                if (Math.random() < .25)
                {
                    ...
                    if (addresseeUserId != userId)
                    {
                        ...
                        System.out.printf("User %d sent message: %s to User : %d%n",this.userId,jsonMessage,addresseeUserId);
                    }
                }
                ...
                if (Math.random() < .05)
                {
                    ...
                    System.out.printf("User %d sent a topic message: %s%n",this.userId,jsonMessage);
                }
            }
